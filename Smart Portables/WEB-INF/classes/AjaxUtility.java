...
public class AjaxUtility {
	...
	public static String getConnection()
	{
		...
		try
		{
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/smarttechdb","root","niku123");							
			message="Successfull";
			return message;
		}
	...
	public static void storeData(HashMap<String,Product> productdata)
	{
		try
		{
			...
			String insertIntoProductQuery = "INSERT INTO product(productId,productName,image,retailer,productCondition,productPrice,productType,discount,warranty,quantity,rebate) "
			+ "VALUES (?,?,?,?,?,?,?,?,?,?,?);";	
			...
			{	
				...
				pst.setInt(9,entry.getValue().getWarranty());
				pst.setInt(10,entry.getValue().getQuantity());
				pst.setDouble(11,entry.getValue().getRebate());
				pst.execute();
			}
		}
		catch(Exception e)
