...
public class SubmitReview extends HttpServlet {
	...
	protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String message=utility.storeReview(productname,producttype,productmaker,reviewrating,reviewdate,reviewtext,retailername,retailerpin,retailercity,retailerstate,productprice,productonsale,age,userid,gender,occupation,rebate,state);				     
