...
public class Carousel{
	...
	public String  carouselfeature(Utilities utility){
		...
		//System.out.println("In carousel.java");
		String name = null;
		...
		for(String user: prodRecmMap.keySet())
		{
			if(user.equals(utility.username()))
			{
				...
				sb.append("<div class='col-md-6'><div id='content'><div class='post'><h2 class='title meta'>");
				...
				*/
				...
				for(String prod : productsList){
					...
					sb.append("<div id='shop_item' style='height:400px'>");
					...
					sb.append("<li><form method='post' action='ViewCart'>" +
							"<input type='hidden' name='name' value='"+prod.trim()+"'>"+
							"<input type='hidden' name='type' value='"+prodObj.getType()+"'>"+
							"<input type='hidden' name='creator' value='"+prodObj.getRetailer()+"'>"+
	...
	/*
		...
		for (OrderItem oi : utility.getCustomerOrders())
		{
			...
			System.out.println(hm.get(oi.getId()));
			if (hm.containsKey(oi.getId()))
			{	
		        
				myCarousel = "myCarousel"+l;
					System.out.println("HEY"+oi.getId());
				sb.append("<div class=\"col-md-9\"><div id='content'><div class='post'><h2 class='title meta'>");
			...
			/*	Laptop laptop1 = hm.get(oi.getId());
				System.out.print("jkadshgak"+ oi.getId());
