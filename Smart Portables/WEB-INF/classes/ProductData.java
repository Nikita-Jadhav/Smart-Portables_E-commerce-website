...
response.setContentType("text/html");			
 ...
 pw.println("<body>");
		...
		pw.print("<td><div id='shop_item'>");
			...
			System.out.println("GGGGGGGGGGGGGGGGGGGGGGG"+data.getType());
			System.out.println("HHHHHHHHHHHHHHHHHHHHHHH"+data.getImage());
			...
			pw.print("<li><form method='post' action='ViewCart'>" +
					...
					"<input type='hidden' name='creator' value='"+data.getRetailer()+"'>"+
