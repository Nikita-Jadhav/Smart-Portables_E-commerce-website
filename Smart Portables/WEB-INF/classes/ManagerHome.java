...
public class ManagerHome extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<form method='get' action='ProductModify'>"
				...
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='Inventoryreport' style = 'font-size:50px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='Salesreport' style = 'font-size:50px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='Choroplethmap' style = 'font-size:50px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
