...
public class PrevAccessory extends HttpServlet {
	...
	/* Phone Page Displays all the Phones and their Information in Smart Tech */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/* Checks the type whether it is DELL, HP or Apple */
	...
	//	int i = 1; int size= hm.size();
		...
		pw.print("<td><li><form method='post' action='NextAccessory'>" +
					...
					"<input type='hidden' name='creator' value='"+CategoryName+"'>"+
					"<input type='hidden' name='access' value='"+ProductName+"'>"+
					"<input type='submit' class='btnbuy' value='Next'></form></li></td></div>");
		pw.print("</tr>");		
